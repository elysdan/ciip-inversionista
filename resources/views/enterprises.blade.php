...
<td><a href="{{route('add_web',$empresa->id)}}" class="btn btn-outline-primary mt-1 mb-1 p-0" style="border-radius:1rem;align-items: center;align-content: center;width: 3vw;height: 3vw;text-align: center;">
