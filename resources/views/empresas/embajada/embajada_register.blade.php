...
@section('content')
    ...
    <body>
<form method="POST" action="{{route('embajada_registrador')}}" id="miFormulario">
@csrf
<div class="previews">
                                  ...
                                  <div class="w-100 mb-5 " style="display: inline-flex;align-items: flex-end">
                                    ...
                                    <table>
                                            ...
                                            <tr style="height:auto">
                                                    ...
                                                    <td  style="padding: 0;"><textarea style="font-size: 100%;width:100%;height: 100%;margin: 0;padding:0;min-height: 5rem;max-height: 5rem;font-family: arial;" placeholder="Sin Resultados" name="ne" id="ne" pattern="[A-Za-z0-9-áÁéÉíÍóÓúÚñÑ.@,;:#$%&/()=?¡¿°!*/+' ']{4,500}" maxlength="500"  required>{{$previa->razonsocial}}</textarea></td>
                                            </tr>
                                    </table>
    <br>
                          ...
                          <br>
                                         <table>
                                            ...
                                            <tr style="height:auto">
                                                    ...
                                                    <td  style="padding: 0;"><textarea style="font-size: 100%;width:100%;height: 100%;margin: 0;padding:0;min-height: 5rem;max-height: 5rem;font-family: arial;" placeholder="Sin Resultados" name="oe" id="oe" pattern="[A-Za-z0-9-áÁéÉíÍóÓúÚñÑ.@,;:#$%&/()=?¡¿°!*/+' ']{4,500}" maxlength="500"  required>{{$previa->oci}}</textarea></td>
                                            </tr>
                                    </table>
    <br>
                          ...
                          <table>
                                            ...
                                            <tr style="height:auto">
                                                    ...
                                                    <td  style="padding: 0;"><textarea style="font-size: 100%;width:100%;height: 100%;margin: 0;padding:0;min-height: 5rem;max-height: 5rem;font-family: arial;" placeholder="Sin Resultados" name="inv" id="inv" pattern="[A-Za-z0-9-áÁéÉíÍóÓúÚñÑ.@,;:#$%&/()=?¡¿°!*/+' ']{4,500}" maxlength="500"  required></textarea></td>
                                            </tr>
                                    </table>
    <br>
                          ...
                          <br>
                           ...
                           <table>
                                            ...
                                            <tr style="height:auto">
                                                    ...
                                                    <td  style="padding: 0;"><textarea style="font-size: 100%;width:100%;height: 100%;margin: 0;padding:0;min-height: 5rem;max-height: 5rem;font-family: arial;" placeholder="Sin Resultados" name="al" id="al" pattern="[A-Za-z0-9-áÁéÉíÍóÓúÚñÑ.@,;:#$%&/()=?¡¿°!*/+' ']{4,500}" maxlength="500"  required>{{$previa->ef}}</textarea></td>
                                            </tr>
                                    </table>
    <br>
                          ...
                          <table>
                                            ...
                                            <tr style="height:auto">
                                                    ...
                                                    <td  style="padding: 0;"><textarea style="font-size: 100%;width:100%;height: 100%;margin: 0;padding:0;min-height: 5rem;max-height: 5rem;font-family: arial;" placeholder="Sin Resultados" name="ob" id="ob" pattern="[A-Za-z0-9-áÁéÉíÍóÓúÚñÑ.@,;:#$%&/()=?¡¿°!*/+' ']{4,500}" maxlength="500"  required></textarea></td>
                                            </tr>
                                    </table>
    <br>
