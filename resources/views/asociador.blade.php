                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>Asociacion de Representantes Empresariales</h2>
                           </div>
                        </div>
                     </div>
...
<a href="{{route('enterprises')}}"><button type="button" 
class="btn btn-outline-secondary mt-3 mb-3 p-0" href="{{url('enterprises')}}"
...
@if(session('usuario')->role >=3 )
              <td class="col-md-1">
                <a href="{{route('asociador_modificar', $representante->id)}}">
                <button type="button" 
...
class="btn btn-outline-danger mt-1 mb-1 p-0" 
 ...
 style="border-radius: 1rem; display: inline-flex; align-items: center; justify-content: center;width: 3vw;height: 3vw;"  
data-toggle="modal" data-target="#DelModal{{$representante->id}}" data-whatever="@mdo"> 
...
<div class="modal fade" id="DelModal{{$representante->id}}" tabindex="-1" role="dialog" aria-labelledby="RegModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Eliminar Representante Legal</h5>
      ...
      <div class="modal-body">
       <h3>¿Desea Eliminar El Representante Legal de la Empresa?</h3>
      </div>
      <div class="modal-footer">
        
       
        <form method="POST" action="{{route('asociador_eliminar', $representante->id)}}" > 
          @csrf 
          @method('PUT')
...
@endforeach
      ...
      <div class="modal fade" id="RegModal" tabindex="-1" role="dialog" aria-labelledby="RegModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Asociacion de Representantes</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <div class="modal-body">
              <form action="{{route('asociador_registrado')}}" method="POST"  id="miFormulario">
                @csrf
...
<script>
  ...
  function validarCampos() {
      ...
      var valido = campo2.selectedIndex != 0 && campo4.selectedIndex != 0;
