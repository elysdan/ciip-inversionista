...
@section('content')
    ...
    <body>
<form method="POST" action="{{route('modificar_elaborar_delegados')}}" id="miFormulario">
@csrf
@method('PUT')
<div class="previews">
                            ...
                            <div style="height: auto;width: 60%;">
                                    ...
                                    <table>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                    <td><textarea style="font-size: 100%;width:100%;height: 100%;margin: 0;padding:0;min-height: 3rem;max-height: 3rem;font-family: arial;" placeholder="Sin Resultados" name="ipol" id="Ipol" pattern="[A-Za-z0-9-áÁéÉíÍóÓúÚñÑ.@:;,#$%&/()=?¡¿°!*/+' ']{4,500}" maxlength="50"  required>{{ $previa->ipol; }}</textarea></td>
