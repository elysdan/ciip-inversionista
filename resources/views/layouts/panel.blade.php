...
<div class="container-fluid" style="max-height: 80vh;">
  <div class="row" style="flex-wrap: nowrap;justify-content: flex-start;align-items: flex-start">
    <div class="sidebar  border-right col-md-3 col-lg-2 p-0 bg-body-tertiary" style="width: 16vw;">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary " tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">Logo de la Empresa</h5>
          <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#sidebarMenu" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="height:86vh">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="{{route('search')}}">
                <svg class="bi"><use xlink:href="#search"/></svg>
                Busqueda
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{route('enterprises')}}">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{route('delegates')}}">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{route('stadistics')}}">
          ...
          <ul class="nav flex-column mb-auto">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{route('configurations')}}">
  ...
  <div class="d-block  " style="position:relative;top:-50vw;left:20vw;width: 70vw;" >
    @yield('usuarios')
  </div>
